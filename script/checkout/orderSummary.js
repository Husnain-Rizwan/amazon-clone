...
cartSummaryHtml += `
      <div class="cart-item-container js-cart-item-container-${matchingProduct.id} js-cart-item-container" data-product-id="${matchingProduct.id}">
...
document.querySelectorAll('.js-update-quantity-link')
  .forEach((link) => {
    link.addEventListener('click', () => {
      ...
      if(containerElement){
        containerElement.classList.add('isUpdated');
      }
    });
  });
